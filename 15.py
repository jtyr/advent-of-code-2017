...
def main():
    ...
    a, b = map(int, get_data(sys.argv[1]))
    am = 16807
    bm = 48271
    astack = []
    bstack = []
    ...
    for n in range(41000000):
        a = a * am - int(a * am / 2147483647) * 2147483647
        b = b * bm - int(b * bm / 2147483647) * 2147483647
        ...
        if n < 40000000 and bin(a)[-16:] == bin(b)[-16:]:
            cnt1 += 1

    for n in range(5000000):
        if bin(astack[n])[-16:] == bin(bstack[n])[-16:]:
            cnt2 += 1
